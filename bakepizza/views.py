...
def home(request):
    return render(request, 'bakepizza/home.html')
...
def order(request):
    ...
    if request.method == 'POST':
        ...
        if filled_form.is_valid():
            ...
            messages.success(request, f'Thanks for your order! Your {size} pizza with {topping1} and {topping2} toppings is on its way!')
        ...
        return render(request, 'bakepizza/order.html', {'created_pizza_pk':created_pizza_pk, 'pizzaform':filled_form, 'multiple_form':multiple_form})
    else:
        form = PizzaForm()
        return render(request, 'bakepizza/order.html', {'pizzaform':form, 'multiple_form':multiple_form})
...
def pizzas(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'bakepizza/pizzas.html', {'formset':formset})
...
def edit_order(request, pk):
    ...
    if request.method == 'POST':
        ...
        if filled_form.is_valid():
           ...
           # return render(request, 'bakepizza/edit_order.html', {'pizzaform':form,'pizza':pizza})
    return render(request, 'bakepizza/edit_order.html', {'pizzaform':form,'pizza':pizza})
